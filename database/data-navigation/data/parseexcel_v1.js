...
async function main() {
    ...
    // const parsedData = convertCSVToData(data);
    //console.log(data);
    console.log(posts);
...
function convertCSVToData(csvString) {
    ...
    // Convert json to our data structure
    // idsOfDimensionValues = populateDimensions(dimensionIds, dimensionData)
